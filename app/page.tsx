...
export default function EntrancePage() {
  return <main id="main" className="entry-page">
    ...
    <div className="entry-robot" role="img" aria-label="Interactive 3D robot"><SplineScene scene={site.heroScene} className="entry-react-canvas" /></div>
    <div className="entry-overlay">
      <div className="entry-identity">
        <strong>Kanishk Dubey</strong>
        <span>AI systems · Connected hardware · Web products</span>
      </div>
